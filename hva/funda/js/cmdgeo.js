...
(function() {
    ...
    var defaultSettings = {
        'googleMapsKey': 'AIzaSyC_e4Rbzte5A2Qle1YtwMZjCdcycca-IBI',
        'tourType': 'LINEAIR',
    ...
    cmdgeo.loadSettings = function loadSettings(obj) {
    ...
    cmdgeo.loadmap = function loadmap() {
        ...
        script.src = 'https://maps.googleapis.com/maps/api/js?v=3.exp&key='+getGoogleMapsKey(cmdgeo.settings)+'&callback=cmdgeo.drawmap';
